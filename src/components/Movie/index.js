...
class Movie extends Component {
  ...
  componentWillMount = () => {
    ...
    fetch(`${PATH_BASE}${PATH_MOVIE}/${MOVIE_ID}?api_key=${API_KEY}&append_to_response=credits,images`)
          ...
          <div className="movie-data">
            ...
            <div className="flex movie-details">
              ...
              <div className="flex detail-list">   
                ...
                {detailList('Release Year', movie.release_date)}
                {detailList('Duration', `${movie.runtime} min`)}
              </div>
            </div> 
